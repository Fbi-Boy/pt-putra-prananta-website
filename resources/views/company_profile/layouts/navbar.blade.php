                            ...
                            <div class="col-span-4">
                                ...
                                >
                                    ...
                                    <div class="grid grid-cols-2 gap-x-5 gap-y-3 mt-6">
                                        ...
                                        <a href="{{ route('company.beli') }}" class="text-sm text-gray-300 hover:text-yellow-400 transition">
                                            Kaliwates
                                        </a>
                            ...
                            <div class="col-span-5">
                                ...
                                <div class="rounded-2xl bg-gray-50 p-6">
                                    ...
                                    <div class="grid grid-cols-2 gap-3 mt-5">
                                        ...
                                        <a href="{{ route('company.beli') }}" class="px-3 py-2.5 rounded-xl bg-white border border-gray-200 text-sm font-medium hover:border-yellow-300 transition">
                                            Kaliwates
                                        </a>
                                ...
                                >
                                    ...
                                    <div class="mt-6 pt-5 border-t border-white/10">
                                        ...
                                        <div class="grid grid-cols-2 gap-3 mt-3">
                                            ...
                                            <a href="{{ route('company.kpr') }}" class="text-xs text-gray-400 hover:text-yellow-400 transition">
                                                Syarat KPR
                                            </a>
                        ...
                        <div class="grid grid-cols-4 gap-10">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <a href="{{ route('company.cari-agent') }}" class="flex items-center gap-3 text-sm text-gray-600 hover:text-gray-950 transition">
                                        <i data-lucide="building" class="w-4 h-4"></i>
                                        Tentang Kami
                                    </a>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <a href="{{ route('company.kpr') }}" class="flex items-center gap-3 text-sm text-gray-600 hover:text-gray-950 transition">
                                        <i data-lucide="house-plus" class="w-4 h-4"></i>
                                        Jual Properti
                                    </a>
