                ...
                >
                    ...
                    <div class="max-w-[1440px] mx-auto px-6 lg:px-10 py-8">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <a
                                href="#"
                                class="group/project relative h-48 overflow-hidden rounded-2xl bg-gray-100"
                            >

                                <img
                                    src="{{ asset('images/property/rumah1.jpg') }}"
                                    alt="Proyek properti baru"
                            ...
                            >
                                ...
                                <img
                                    src="{{ asset('images/property/rumah2.jpg') }}"
                                    alt="Proyek properti baru"
                                    class="w-full h-full object-cover
                                           group-hover/project:scale-105
                                           transition duration-500"
                            ...
                            >
                                ...
                                <img
                                    src="{{ asset('images/property/rumah3.jpg') }}"
                                    alt="Proyek properti baru"
                                    class="w-full h-full object-cover
                                           group-hover/project:scale-105
                                           transition duration-500"
